...
if __name__ == '__main__':
    ...
    subprocess.run(f'python train.py --dataroot {root_folder} --name Test_Model --model DeepLIIF --remote True --pickle_transfer_cmd custom_save.save_to_storage_volume --batch_size 2 --display_env $APP_ID',shell=True)
