...
subprocess.Popen('pip install dominate visdom gpustat numba torch==1.10.1 --user; bash monitor_gpu.sh',shell=True)
...
if __name__ == '__main__':
    ...
    subprocess.run(f'python cli.py train --dataroot {root_folder} --name Test_Model --remote True --remote_transfer_cmd custom_save.save_to_storage_volume --batch_size 2 --display_env $APP_ID',shell=True)
