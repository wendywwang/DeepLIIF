...
class DeepLIIFModel(BaseModel):
    ...
    def __init__(self, gpu_ids, is_train, checkpoints_dir, name, preprocess, targets_no, input_nc, output_nc, ngf, net_g,
                 norm, no_dropout, init_type, init_gain, ndf, net_d, n_layers_d, lr, beta1, lambda_l1, lr_policy, remote_transfer,
                 remote_transfer_cmd):
        ...
        """
        BaseModel.__init__(self, gpu_ids, is_train, checkpoints_dir, name, preprocess, lr_policy, remote_transfer,
                           remote_transfer_cmd)
